...
```
I tried to figure out how to get these into one map, but couldn't. Commented out the increase map for now.
...
This was actually intresting. I expected, as I said earlier, for mostly Unionist areas to have a decrease in the % that was enslaved, but I didn't get that result. There are a couple of hotspots in areas of what's now West Virginia, but it's hardly the rule. There's lots of increases, too.
